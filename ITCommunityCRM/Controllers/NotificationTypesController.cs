...
namespace ITCommunityCRM.Controllers
{
    public class NotificationTypesController : Controller
    {
        ...
        public NotificationTypesController(ITCommunityCRMDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.NotificationTypes != null ? 
                          ...
                          Problem("Entity set 'ITCommunityCRMDbContext.NotificationTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ITCommunityCRMDbContext.NotificationTypes'  is null.");
            }
            var notificationType = await _context.NotificationTypes.FindAsync(id);
            if (notificationType != null)
            {
